...
|        | [optional] ISLR book from    4.4.1 upto 4.4.4.                                             | densities   as  MVN lead to quadratic discriminant analysis(QDA) and linear discriminant analysis (LDA) when $\Sigma_c = \Sigma$ |
