...
|----+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  2 | sep 28   | 3.6, 3.7, *3.11(only if enrolled in ENCE 4630)*, 3.20, 4.1(look into section 2.5.1 for definition of correlation coefficient), *4.14(only if enrolled in ENCE 4630)* |
|    |          |                                                                                                                                                                      |
...
|        | [optional] ISLR book from    4.4.1 upto 4.4.4.                                             | densities   as  MVN lead to quadratic discriminant analysis(QDA) and linear discriminant analysis (LDA)                   |
