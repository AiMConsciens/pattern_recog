...
|--------+--------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------|
| 21 Sep | k. M. book  4.1 upto 4.2.5                                                                 | We covered navie bayes and looked into mutlivariate gaussian(MVG). How modelling class condition                          |
|        | [optional] ISLR book from    4.4.1 upto 4.4.4.                                             | densities $P(y=k X, \theta)$ as  MVN lead to quadratic discrimant analysis(QDA) and linear discriminant analysis (LDA)    |
